...
class RecTransformer(nn.Module):
    ...
    def gru_hidden(self, image_emb, text_emb):
        x1 = image_emb
        x2 = text_emb
        # x = x1 + x2
        ...
        gate = torch.sigmoid(x2+self.hx)
        
        self.hx = (1-gate)*x2 + self.rnn(x, self.hx)
    ...
    def merge_forward(self, image_input, text_input):
        ...
        # hidden part
        # B x 1 x H
        self.hx = self.gru_hidden(image_emb, text_emb)
        self.hist_vectors.append(self.hx.unsqueeze(dim=1))
