...
from models.gommir_no_comploss.model_transformer import RecTransformer
from models.gommir_no_comploss.eval_utils import evaluation

parser = argparse.ArgumentParser(description='MMCRS')

# user simulator
parser.add_argument('--data-type', type=str, default="",
                    help='dress, shirt, toptee,shoe,shoe-large')
