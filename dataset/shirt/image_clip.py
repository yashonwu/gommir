...
image_dir = 'images'
train_split = 'image_splits/split.shirt.train.filter.json'
val_split = 'image_splits/split.shirt.val.filter.json'
test_split = 'image_splits/split.shirt.test.filter.json'
