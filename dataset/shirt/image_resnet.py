...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_split', default='image_splits/split.shirt.train.filter.json', type=str, help='')
    parser.add_argument('--val_split', default='image_splits/split.shirt.val.filter.json', type=str, help='')
    parser.add_argument('--test_split', default='image_splits/split.shirt.test.filter.json', type=str, help='')
