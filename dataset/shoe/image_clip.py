...
image_dir = 'images'
train_split = 'image_splits/split.shoe.train.filter.json'
val_split = 'image_splits/split.shoe.val.filter.json'
test_split = 'image_splits/split.shoe.test.filter.json'
