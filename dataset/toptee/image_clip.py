...
image_dir = 'images'
train_split = 'image_splits/split.toptee.train.filter.json'
val_split = 'image_splits/split.toptee.val.filter.json'
test_split = 'image_splits/split.toptee.test.filter.json'
