...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_split', default='image_splits/split.toptee.train.filter.json', type=str, help='')
    parser.add_argument('--val_split', default='image_splits/split.toptee.val.filter.json', type=str, help='')
    parser.add_argument('--test_split', default='image_splits/split.toptee.test.filter.json', type=str, help='')
